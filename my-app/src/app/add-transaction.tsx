...
export default function AddTransactionScreen() {
  ...
  const handleTypeSwitch = (t: TxType) => {
    setTxType(t);
    setSelectedCat(null);
  };

  const displayAmount = fmtVND(rawAmount);
  const canSubmit     = rawAmount.replace(/\D/g, "").length > 0 && selectedCat !== null;
  ...
  // Short helper — pick Vietnamese or English string
      ...
      >
        ...
        <View style={styles.header}>
          <Text style={styles.headerSup}>
            {s("Thêm giao dịch", "Add Transaction")}
          </Text>
        ...
        <View style={styles.card}>
          <Text style={styles.fieldLabel}>
            {s("Loại giao dịch", "Transaction Type")}
          </Text>
        ...
        <View style={styles.card}>
          <Text style={styles.fieldLabel}>
            ...
            <Text style={styles.optionalTag}>
              {s("(không bắt buộc)", "(optional)")}
            </Text>
          </Text>
          <TextInput
            style={styles.notesInput}
            placeholder={s(
              "VD: Ăn trưa với đồng nghiệp",
        ...
        <View style={styles.submitArea}>
          <TouchableOpacity
            style={[
              styles.submitBtn,
              { backgroundColor: canSubmit ? COLORS.heroBg : "#C8D8D4" },
            ]}
          ...
          >
            <Text style={styles.submitBtnText}>
              {isExpense
                ? s("＋ Lưu chi tiêu", "＋ Save Expense")
                : s("＋ Lưu thu nhập", "＋ Save Income")}
            </Text>
          </TouchableOpacity>
        ...
        <Animated.View style={[styles.toast, { opacity: toastOpacity }]}>
          ...
          <View>
            ...
            <Text style={styles.toastSub}>
              {s("Giao dịch đã được thêm", "Transaction added")}
            </Text>
          </View>
        </Animated.View>
      )}
...
const styles = StyleSheet.create({
  ...
  catCell: {
    ...
    borderRadius: R.md,
    backgroundColor: COLORS.catInactiveBg,
    borderWidth: 2,
    borderColor: "transparent",
  },
  catCellActive: {
    backgroundColor: COLORS.catActiveBg,
